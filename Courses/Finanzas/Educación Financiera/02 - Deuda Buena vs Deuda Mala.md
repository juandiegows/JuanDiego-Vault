...
```
Compras $1.000 en tarjeta de crédito al 36% anual (3%/mes)
Solo pagas el mínimo ($30/mes)
Tiempo para pagar: +6 años
Total pagado: $2.160+
Costo real de esa compra: más del doble
```
...
Paga primero la deuda **más pequeña** en saldo, sin importar la tasa.
- **Pro:** Victorias rápidas → motivación
- **Con:** Pagas más interés total

### Método Avalancha (matemáticamente óptimo)
Paga primero la deuda con la **tasa más alta**.
- **Pro:** Pagas menos interés total
- **Con:** Puede tomar más tiempo ver progreso
