...
> *"Los ricos construyen redes. Los demás buscan trabajo."*
> — Padre Rico
...
> *"¿A qué negocio creen que me dedico?"*

Los estudiantes responden: *"Hamburguesas."*

Kroc los corrige: **"Me dedico al negocio de los bienes raíces."**

McDonald's no vende hamburguesas. Vende **ubicaciones inmobiliarias** que se financian con hamburguesas. Cada franquicia ocupa una propiedad estratégica que McDonald's posee o controla.

> [!IMPORTANT] El negocio en el que **apareces** no es necesariamente el negocio en el que **estás**. Los ricos saben cuál es su negocio real — la columna de activos.
...
| | **Profesión** | **Negocio Propio** |
|---|---|---|
| **¿Qué es?** | Tu trabajo o empleo actual | Tu columna de activos |
| **Quién se beneficia** | Tu empleador (mayoritariamente) | Tú |
| **Si dejas de trabajar** | Los ingresos se detienen | Los ingresos continúan |
| **Ejemplos** | Médico, abogado, ingeniero, desarrollador | Inmuebles, acciones, negocios, IP |

**El problema de confundir ambas:**

Un médico dice *"tengo mi propio consultorio"* — pero si se enferma y no trabaja, no genera ingresos. Eso no es un negocio. Es un trabajo con otro dueño: él mismo.

Un negocio real es aquel que **genera ingresos aunque no estés presente.**
...
Tu empleo actual es necesario para:
1. Pagar tus gastos mientras construyes activos
2. Generar el capital inicial para invertir
3. Mantenerte mientras tus activos maduran

**El cambio es mental, no inmediato:**

```
ANTES: Salario → Gastos → (nada queda)
DESPUÉS: Salario → Gastos básicos → Activos → más ingresos → más activos
```

La clave es simple pero difícil: **cada vez que recibes dinero, compra un activo antes de aumentar tus gastos.**
...
```
¿Puedo primero comprar un activo que pague esto?

Ejemplo:
Quiero un gadget de $500
→ ¿Puedo primero invertir $500 en algo que genere $50/mes?
→ En 10 meses el activo pagó el gadget
→ Y luego sigue generando $50/mes para siempre
```
...
- No necesitas renunciar a tu trabajo para empezar — necesitas redirigir cada peso extra hacia activos en lugar de pasivos.
- Un negocio real genera ingresos **aunque no estés presente**. Todo lo demás es un trabajo con otro nombre.
